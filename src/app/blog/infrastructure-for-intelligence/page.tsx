...
export default function InfrastructureIntelligencePage() {
  const post = {
    ...
    content: `
      ...
      <p>In the realm of B2B outreach, the primary bottleneck is not the execution of emails or calls, but rather the strategic identification of the optimal prospects to contact. If you have a list of 1,000 businesses, calling them alphabetically is a recipe for burnout. Some of those businesses are desperate for your service, while others will never need it.</p>
      ...
      <p>Does the business have a website? Is their Google profile updated? Do they have a high volume of foot traffic? If a business presents a professional digital presence alongside suboptimal physical infrastructure, our AI identifies a "Visual Gap," indicating a commercial entity that values its brand image but requires immediate physical remediation. That is a goldmine lead.</p>
      ...
      <p>By exclusively focusing on the top tier of leads identified as high-intent by our engine, our clients have achieved:</p>
      <ol>
      ...
      <p>At Viracis, we move beyond merely adopting AI; we architect the robust infrastructure necessary to transform artificial intelligence into a tangible business asset. If your organization is prepared to eliminate guesswork and systematically engineer growth, we invite you to initiate a conversation.</p>
    `,
    recentPosts: [
      {
