  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={`md:hidden fixed inset-0 z-[55] bg-viracis-navy text-white flex flex-col pt-32 px-8 ${mobileOpen ? "pointer-events-auto" : "pointer-events-none"
          }`}
      >
        ...
        >
          <div className="grid grid-cols-2 gap-8 text-xs tracking-wider uppercase font-bold text-white/30">
            ...
            <div>
              ...
              <p className="text-white/60">Richmond, VA</p>
              <p className="text-white/60">© {new Date().getFullYear()}</p>
            </div>
          </div>
        </motion.div>
      </motion.div>
